		...
		<div class="container">
			...
			<!--			<?php echo $logo; ?>
					...
					<div class="header-search top-logo">
						<jdoc:include type="modules" name="top_logo" style="none" />
					</div>
				</div>
			</header>
<!--			<?php if ($this->countModules('above_hero')) : ?>-->
				...
				<nav class="navigation" role="navigation">
					...
					<div>
						<jdoc:include type="modules" name="above_hero" style="none" /><h3>above_hero</h3>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio quaerat laborum odit repudiandae quam amet cumque aperiam mollitia aliquid assumenda ipsam officia aspernatur praesentium, similique, voluptates, quasi eveniet ad. Nobis.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Itaque vero dolores quod enim nemo voluptates ullam sit ut, tempora, laborum ratione minus eos minima maxime fugiat unde! Hic, magnam, reiciendis.
					</div>
				</nav>
...
<!--			<?php endif; ?>-->
			...
			<h3>HERO</h3>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio quaerat laborum odit repudiandae quam amet cumque aperiam mollitia aliquid assumenda ipsam officia aspernatur praesentium, similique, voluptates, quasi eveniet ad. Nobis.Lorem ipsum dolor sit amet, 
			<div>
	...
	<footer class="footer" role="contentinfo">
	 ...
	 £app <div class="navbar-collapse collapse inverse" id="navbar-header">
...
<div class="outer">
		<div class="container">
		<input type="text" class="btn btn-default" value="frog">
